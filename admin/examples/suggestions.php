                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                    <h4 class="title">User Suggestions Table</h4>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows>0) {
                                                ...
                                                <td><?php //$date=date_create($row['d']);echo $row["Date"];?></td>
                                                <td><?php //echo $row["Time"];?></td>
                                                <td ><?php echo $row["bfunction"];?></td>
                                                <td ><?php echo $row["description"];?></td>
                                                <td ><?php echo $row["brodmannarea"];?></td>
                                                <!-- <td class="text-primary"><?//php echo $row["Reserch Paper"];?></td> -->
